...
/**
 * Pin , see Node interface and ComponentNode class for documentation for some 
 * methods. Surface pin, no child nodes.
 * */
@SuppressWarnings("serial")
public class Pin extends ComponentNode{
	public Pin(Color c, String image){
		super(c);
		this.c = c;
		this.image = image;
		label = "";
